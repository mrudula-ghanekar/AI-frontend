...
const API_BASE_URL = process.env.REACT_APP_API_BASE_URL || 'https://ai-backend-mg.up.railway.app'; // ✅ Replace with actual backend URL (Railway hosted)
...
const ResumeAnalyzer = () => {
  ...
  // Handle the upload of files and analyze them
